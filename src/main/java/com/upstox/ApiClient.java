...
public class ApiClient {
    ...
    private static Map<String, Authentication> authentications;
     ...
     */
	/*
	 * public int getConnectTimeout() { return httpClient.getConnectTimeout(); }
	 */
	 ...
	 * httpClient.setReadTimeout(readTimeout, TimeUnit.MILLISECONDS); return this; }
	 */
	 ...
	 * httpClient.setWriteTimeout(writeTimeout, TimeUnit.MILLISECONDS); return this;
	 * }
	 */
    ...
    public void processHeaderParams(Map<String, String> headerParams, Request.Builder reqBuilder) {
        for (Entry<String, String> param : headerParams.entrySet()) {
            reqBuilder.addHeader(param.getKey(), parameterToString(param.getValue()));
        }
    ...
    private void applySslSettings() {
        try {
            ...
            if (keyManagers != null || trustManagers != null) {
                ...
                X509TrustManager trustManager=extractX509TrustManager(trustManagers);
