...
public class UserApi {
     ...
     */
    public okhttp3.Call getProfileCall(String apiVersion, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private okhttp3.Call getProfileValidateBeforeCall(String apiVersion, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling getProfile(Async)");
        }
        
        okhttp3.Call call = getProfileCall(apiVersion, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<GetProfileResponse> getProfileWithHttpInfo(String apiVersion) throws ApiException {
        okhttp3.Call call = getProfileValidateBeforeCall(apiVersion, null, null);
     ...
     */
    public okhttp3.Call getProfileAsync(String apiVersion, final ApiCallback<GetProfileResponse> callback) throws ApiException {
        ...
        okhttp3.Call call = getProfileValidateBeforeCall(apiVersion, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetProfileResponse>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public okhttp3.Call getUserFundMarginCall(String apiVersion, String segment, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getUserFundMarginValidateBeforeCall(String apiVersion, String segment, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling getUserFundMargin(Async)");
        }
        
        okhttp3.Call call = getUserFundMarginCall(apiVersion, segment, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<GetUserFundMarginResponse> getUserFundMarginWithHttpInfo(String apiVersion, String segment) throws ApiException {
        okhttp3.Call call = getUserFundMarginValidateBeforeCall(apiVersion, segment, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call getUserFundMarginAsync(String apiVersion, String segment, final ApiCallback<GetUserFundMarginResponse> callback) throws ApiException {
        ...
        okhttp3.Call call = getUserFundMarginValidateBeforeCall(apiVersion, segment, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetUserFundMarginResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
