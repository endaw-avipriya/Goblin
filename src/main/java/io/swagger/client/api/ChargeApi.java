...
public class ChargeApi {
     ...
     */
    public okhttp3.Call getBrokerageCall(String instrumentToken, Integer quantity, String product, String transactionType, Float price, String apiVersion, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private okhttp3.Call getBrokerageValidateBeforeCall(String instrumentToken, Integer quantity, String product, String transactionType, Float price, String apiVersion, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        okhttp3.Call call = getBrokerageCall(instrumentToken, quantity, product, transactionType, price, apiVersion, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<GetBrokerageResponse> getBrokerageWithHttpInfo(String instrumentToken, Integer quantity, String product, String transactionType, Float price, String apiVersion) throws ApiException {
        okhttp3.Call call = getBrokerageValidateBeforeCall(instrumentToken, quantity, product, transactionType, price, apiVersion, null, null);
     ...
     */
    public okhttp3.Call getBrokerageAsync(String instrumentToken, Integer quantity, String product, String transactionType, Float price, String apiVersion, final ApiCallback<GetBrokerageResponse> callback) throws ApiException {
        ...
        okhttp3.Call call = getBrokerageValidateBeforeCall(instrumentToken, quantity, product, transactionType, price, apiVersion, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetBrokerageResponse>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public okhttp3.Call postMarginCall(MarginRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postMarginValidateBeforeCall(MarginRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling postMargin(Async)");
        }
        
        okhttp3.Call call = postMarginCall(body, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<PostMarginResponse> postMarginWithHttpInfo(MarginRequest body) throws ApiException {
        okhttp3.Call call = postMarginValidateBeforeCall(body, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call postMarginAsync(MarginRequest body, final ApiCallback<PostMarginResponse> callback) throws ApiException {
        ...
        okhttp3.Call call = postMarginValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PostMarginResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
