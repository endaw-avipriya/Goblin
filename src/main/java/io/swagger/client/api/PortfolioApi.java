...
public class PortfolioApi {
     ...
     */
    public okhttp3.Call convertPositionsCall(ConvertPositionRequest body, String apiVersion, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private okhttp3.Call convertPositionsValidateBeforeCall(ConvertPositionRequest body, String apiVersion, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        okhttp3.Call call = convertPositionsCall(body, apiVersion, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<ConvertPositionResponse> convertPositionsWithHttpInfo(ConvertPositionRequest body, String apiVersion) throws ApiException {
        okhttp3.Call call = convertPositionsValidateBeforeCall(body, apiVersion, null, null);
     ...
     */
    public okhttp3.Call convertPositionsAsync(ConvertPositionRequest body, String apiVersion, final ApiCallback<ConvertPositionResponse> callback) throws ApiException {
        ...
        okhttp3.Call call = convertPositionsValidateBeforeCall(body, apiVersion, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ConvertPositionResponse>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public okhttp3.Call getHoldingsCall(String apiVersion, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getHoldingsValidateBeforeCall(String apiVersion, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling getHoldings(Async)");
        }
        
        okhttp3.Call call = getHoldingsCall(apiVersion, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<GetHoldingsResponse> getHoldingsWithHttpInfo(String apiVersion) throws ApiException {
        okhttp3.Call call = getHoldingsValidateBeforeCall(apiVersion, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call getHoldingsAsync(String apiVersion, final ApiCallback<GetHoldingsResponse> callback) throws ApiException {
        ...
        okhttp3.Call call = getHoldingsValidateBeforeCall(apiVersion, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetHoldingsResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public okhttp3.Call getPositionsCall(String apiVersion, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getPositionsValidateBeforeCall(String apiVersion, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling getPositions(Async)");
        }
        
        okhttp3.Call call = getPositionsCall(apiVersion, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<GetPositionResponse> getPositionsWithHttpInfo(String apiVersion) throws ApiException {
        okhttp3.Call call = getPositionsValidateBeforeCall(apiVersion, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call getPositionsAsync(String apiVersion, final ApiCallback<GetPositionResponse> callback) throws ApiException {
        ...
        okhttp3.Call call = getPositionsValidateBeforeCall(apiVersion, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetPositionResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
