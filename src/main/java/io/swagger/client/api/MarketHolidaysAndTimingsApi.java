...
public class MarketHolidaysAndTimingsApi {
     ...
     */
    public okhttp3.Call getExchangeTimingsCall(String date, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private okhttp3.Call getExchangeTimingsValidateBeforeCall(String date, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'date' is set
        if (date == null) {
            throw new ApiException("Missing the required parameter 'date' when calling getExchangeTimings(Async)");
        }
        
        okhttp3.Call call = getExchangeTimingsCall(date, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<GetExchangeTimingResponse> getExchangeTimingsWithHttpInfo(String date) throws ApiException {
        okhttp3.Call call = getExchangeTimingsValidateBeforeCall(date, null, null);
     ...
     */
    public okhttp3.Call getExchangeTimingsAsync(String date, final ApiCallback<GetExchangeTimingResponse> callback) throws ApiException {
        ...
        okhttp3.Call call = getExchangeTimingsValidateBeforeCall(date, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetExchangeTimingResponse>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public okhttp3.Call getHolidayCall(String date, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getHolidayValidateBeforeCall(String date, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'date' is set
        if (date == null) {
            throw new ApiException("Missing the required parameter 'date' when calling getHoliday(Async)");
        }
        
        okhttp3.Call call = getHolidayCall(date, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<GetHolidayResponse> getHolidayWithHttpInfo(String date) throws ApiException {
        okhttp3.Call call = getHolidayValidateBeforeCall(date, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call getHolidayAsync(String date, final ApiCallback<GetHolidayResponse> callback) throws ApiException {
        ...
        okhttp3.Call call = getHolidayValidateBeforeCall(date, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetHolidayResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public okhttp3.Call getHolidaysCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getHolidaysValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        okhttp3.Call call = getHolidaysCall(progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<GetHolidayResponse> getHolidaysWithHttpInfo() throws ApiException {
        okhttp3.Call call = getHolidaysValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<GetHolidayResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call getHolidaysAsync(final ApiCallback<GetHolidayResponse> callback) throws ApiException {
        ...
        okhttp3.Call call = getHolidaysValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetHolidayResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public okhttp3.Call getMarketStatusCall(String exchange, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getMarketStatusValidateBeforeCall(String exchange, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'exchange' is set
        if (exchange == null) {
            throw new ApiException("Missing the required parameter 'exchange' when calling getMarketStatus(Async)");
        }
        
        okhttp3.Call call = getMarketStatusCall(exchange, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<GetMarketStatusResponse> getMarketStatusWithHttpInfo(String exchange) throws ApiException {
        okhttp3.Call call = getMarketStatusValidateBeforeCall(exchange, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call getMarketStatusAsync(String exchange, final ApiCallback<GetMarketStatusResponse> callback) throws ApiException {
        ...
        okhttp3.Call call = getMarketStatusValidateBeforeCall(exchange, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetMarketStatusResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
