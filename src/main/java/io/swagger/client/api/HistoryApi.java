...
public class HistoryApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public okhttp3.Call getHistoricalCandleData1Call(String instrumentKey, String interval, String toDate, String fromDate, String apiVersion, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    private okhttp3.Call getHistoricalCandleData1ValidateBeforeCall(String instrumentKey, String interval, String toDate, String fromDate, String apiVersion, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        okhttp3.Call call = getHistoricalCandleData1Call(instrumentKey, interval, toDate, fromDate, apiVersion, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<GetHistoricalCandleResponse> getHistoricalCandleData1WithHttpInfo(String instrumentKey, String interval, String toDate, String fromDate, String apiVersion) throws ApiException {
        okhttp3.Call call = getHistoricalCandleData1ValidateBeforeCall(instrumentKey, interval, toDate, fromDate, apiVersion, null, null);
        Type localVarReturnType = new TypeToken<GetHistoricalCandleResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call getHistoricalCandleData1Async(String instrumentKey, String interval, String toDate, String fromDate, String apiVersion, final ApiCallback<GetHistoricalCandleResponse> callback) throws ApiException {
        ...
        okhttp3.Call call = getHistoricalCandleData1ValidateBeforeCall(instrumentKey, interval, toDate, fromDate, apiVersion, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetHistoricalCandleResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public okhttp3.Call getIntraDayCandleDataCall(String instrumentKey, String interval, String apiVersion, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getIntraDayCandleDataValidateBeforeCall(String instrumentKey, String interval, String apiVersion, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'instrumentKey' is set
        if (instrumentKey == null) {
        ...
        okhttp3.Call call = getIntraDayCandleDataCall(instrumentKey, interval, apiVersion, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<GetIntraDayCandleResponse> getIntraDayCandleDataWithHttpInfo(String instrumentKey, String interval, String apiVersion) throws ApiException {
        okhttp3.Call call = getIntraDayCandleDataValidateBeforeCall(instrumentKey, interval, apiVersion, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call getIntraDayCandleDataAsync(String instrumentKey, String interval, String apiVersion, final ApiCallback<GetIntraDayCandleResponse> callback) throws ApiException {
        ...
        okhttp3.Call call = getIntraDayCandleDataValidateBeforeCall(instrumentKey, interval, apiVersion, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetIntraDayCandleResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
