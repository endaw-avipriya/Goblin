...
public class PostTradeApi {
     ...
     */
    public okhttp3.Call getTradesByDateRangeCall(String startDate, String endDate, Integer pageNumber, Integer pageSize, String segment, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private okhttp3.Call getTradesByDateRangeValidateBeforeCall(String startDate, String endDate, Integer pageNumber, Integer pageSize, String segment, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        okhttp3.Call call = getTradesByDateRangeCall(startDate, endDate, pageNumber, pageSize, segment, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<TradeHistoryResponse> getTradesByDateRangeWithHttpInfo(String startDate, String endDate, Integer pageNumber, Integer pageSize, String segment) throws ApiException {
        okhttp3.Call call = getTradesByDateRangeValidateBeforeCall(startDate, endDate, pageNumber, pageSize, segment, null, null);
     ...
     */
    public okhttp3.Call getTradesByDateRangeAsync(String startDate, String endDate, Integer pageNumber, Integer pageSize, String segment, final ApiCallback<TradeHistoryResponse> callback) throws ApiException {
        ...
        okhttp3.Call call = getTradesByDateRangeValidateBeforeCall(startDate, endDate, pageNumber, pageSize, segment, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TradeHistoryResponse>(){}.getType();
