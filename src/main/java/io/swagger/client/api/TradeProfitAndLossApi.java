...
public class TradeProfitAndLossApi {
     ...
     */
    public okhttp3.Call getProfitAndLossChargesCall(String segment, String financialYear, String apiVersion, String fromDate, String toDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private okhttp3.Call getProfitAndLossChargesValidateBeforeCall(String segment, String financialYear, String apiVersion, String fromDate, String toDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        okhttp3.Call call = getProfitAndLossChargesCall(segment, financialYear, apiVersion, fromDate, toDate, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<GetProfitAndLossChargesResponse> getProfitAndLossChargesWithHttpInfo(String segment, String financialYear, String apiVersion, String fromDate, String toDate) throws ApiException {
        okhttp3.Call call = getProfitAndLossChargesValidateBeforeCall(segment, financialYear, apiVersion, fromDate, toDate, null, null);
     ...
     */
    public okhttp3.Call getProfitAndLossChargesAsync(String segment, String financialYear, String apiVersion, String fromDate, String toDate, final ApiCallback<GetProfitAndLossChargesResponse> callback) throws ApiException {
        ...
        okhttp3.Call call = getProfitAndLossChargesValidateBeforeCall(segment, financialYear, apiVersion, fromDate, toDate, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetProfitAndLossChargesResponse>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public okhttp3.Call getTradeWiseProfitAndLossDataCall(String segment, String financialYear, Integer pageNumber, Integer pageSize, String apiVersion, String fromDate, String toDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getTradeWiseProfitAndLossDataValidateBeforeCall(String segment, String financialYear, Integer pageNumber, Integer pageSize, String apiVersion, String fromDate, String toDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'segment' is set
        if (segment == null) {
        ...
        okhttp3.Call call = getTradeWiseProfitAndLossDataCall(segment, financialYear, pageNumber, pageSize, apiVersion, fromDate, toDate, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<GetTradeWiseProfitAndLossDataResponse> getTradeWiseProfitAndLossDataWithHttpInfo(String segment, String financialYear, Integer pageNumber, Integer pageSize, String apiVersion, String fromDate, String toDate) throws ApiException {
        okhttp3.Call call = getTradeWiseProfitAndLossDataValidateBeforeCall(segment, financialYear, pageNumber, pageSize, apiVersion, fromDate, toDate, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call getTradeWiseProfitAndLossDataAsync(String segment, String financialYear, Integer pageNumber, Integer pageSize, String apiVersion, String fromDate, String toDate, final ApiCallback<GetTradeWiseProfitAndLossDataResponse> callback) throws ApiException {
        ...
        okhttp3.Call call = getTradeWiseProfitAndLossDataValidateBeforeCall(segment, financialYear, pageNumber, pageSize, apiVersion, fromDate, toDate, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetTradeWiseProfitAndLossDataResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public okhttp3.Call getTradeWiseProfitAndLossMetaDataCall(String segment, String financialYear, String apiVersion, String fromDate, String toDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getTradeWiseProfitAndLossMetaDataValidateBeforeCall(String segment, String financialYear, String apiVersion, String fromDate, String toDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'segment' is set
        if (segment == null) {
        ...
        okhttp3.Call call = getTradeWiseProfitAndLossMetaDataCall(segment, financialYear, apiVersion, fromDate, toDate, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<GetTradeWiseProfitAndLossMetaDataResponse> getTradeWiseProfitAndLossMetaDataWithHttpInfo(String segment, String financialYear, String apiVersion, String fromDate, String toDate) throws ApiException {
        okhttp3.Call call = getTradeWiseProfitAndLossMetaDataValidateBeforeCall(segment, financialYear, apiVersion, fromDate, toDate, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call getTradeWiseProfitAndLossMetaDataAsync(String segment, String financialYear, String apiVersion, String fromDate, String toDate, final ApiCallback<GetTradeWiseProfitAndLossMetaDataResponse> callback) throws ApiException {
        ...
        okhttp3.Call call = getTradeWiseProfitAndLossMetaDataValidateBeforeCall(segment, financialYear, apiVersion, fromDate, toDate, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetTradeWiseProfitAndLossMetaDataResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
