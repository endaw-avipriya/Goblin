...
public class WebsocketApi {
     ...
     */
    public okhttp3.Call getMarketDataFeedCall(String apiVersion, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private okhttp3.Call getMarketDataFeedValidateBeforeCall(String apiVersion, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling getMarketDataFeed(Async)");
        }
        
        okhttp3.Call call = getMarketDataFeedCall(apiVersion, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<Void> getMarketDataFeedWithHttpInfo(String apiVersion) throws ApiException {
        okhttp3.Call call = getMarketDataFeedValidateBeforeCall(apiVersion, null, null);
     ...
     */
    public okhttp3.Call getMarketDataFeedAsync(String apiVersion, final ApiCallback<Void> callback) throws ApiException {
        ...
        okhttp3.Call call = getMarketDataFeedValidateBeforeCall(apiVersion, progressListener, progressRequestListener);
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public okhttp3.Call getMarketDataFeedAuthorizeCall(String apiVersion, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getMarketDataFeedAuthorizeValidateBeforeCall(String apiVersion, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling getMarketDataFeedAuthorize(Async)");
        }
        
        okhttp3.Call call = getMarketDataFeedAuthorizeCall(apiVersion, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<WebsocketAuthRedirectResponse> getMarketDataFeedAuthorizeWithHttpInfo(String apiVersion) throws ApiException {
        okhttp3.Call call = getMarketDataFeedAuthorizeValidateBeforeCall(apiVersion, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call getMarketDataFeedAuthorizeAsync(String apiVersion, final ApiCallback<WebsocketAuthRedirectResponse> callback) throws ApiException {
        ...
        okhttp3.Call call = getMarketDataFeedAuthorizeValidateBeforeCall(apiVersion, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<WebsocketAuthRedirectResponse>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public okhttp3.Call getPortfolioStreamFeedCall(String apiVersion, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getPortfolioStreamFeedValidateBeforeCall(String apiVersion, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling getPortfolioStreamFeed(Async)");
        }
        
        okhttp3.Call call = getPortfolioStreamFeedCall(apiVersion, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<Void> getPortfolioStreamFeedWithHttpInfo(String apiVersion) throws ApiException {
        okhttp3.Call call = getPortfolioStreamFeedValidateBeforeCall(apiVersion, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call getPortfolioStreamFeedAsync(String apiVersion, final ApiCallback<Void> callback) throws ApiException {
        ...
        okhttp3.Call call = getPortfolioStreamFeedValidateBeforeCall(apiVersion, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public okhttp3.Call getPortfolioStreamFeedAuthorizeCall(String apiVersion, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getPortfolioStreamFeedAuthorizeValidateBeforeCall(String apiVersion, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling getPortfolioStreamFeedAuthorize(Async)");
        }
        
        okhttp3.Call call = getPortfolioStreamFeedAuthorizeCall(apiVersion, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<WebsocketAuthRedirectResponse> getPortfolioStreamFeedAuthorizeWithHttpInfo(String apiVersion) throws ApiException {
        okhttp3.Call call = getPortfolioStreamFeedAuthorizeValidateBeforeCall(apiVersion, null, null);
        Type localVarReturnType = new TypeToken<WebsocketAuthRedirectResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call getPortfolioStreamFeedAuthorizeAsync(String apiVersion, final ApiCallback<WebsocketAuthRedirectResponse> callback) throws ApiException {
        ...
        okhttp3.Call call = getPortfolioStreamFeedAuthorizeValidateBeforeCall(apiVersion, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<WebsocketAuthRedirectResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
