...
public class MarketQuoteApi {
     ...
     */
    public okhttp3.Call getFullMarketQuoteCall(String symbol, String apiVersion, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private okhttp3.Call getFullMarketQuoteValidateBeforeCall(String symbol, String apiVersion, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        okhttp3.Call call = getFullMarketQuoteCall(symbol, apiVersion, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<GetFullMarketQuoteResponse> getFullMarketQuoteWithHttpInfo(String symbol, String apiVersion) throws ApiException {
        okhttp3.Call call = getFullMarketQuoteValidateBeforeCall(symbol, apiVersion, null, null);
     ...
     */
    public okhttp3.Call getFullMarketQuoteAsync(String symbol, String apiVersion, final ApiCallback<GetFullMarketQuoteResponse> callback) throws ApiException {
        ...
        okhttp3.Call call = getFullMarketQuoteValidateBeforeCall(symbol, apiVersion, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetFullMarketQuoteResponse>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public okhttp3.Call getMarketQuoteOHLCCall(String symbol, String interval, String apiVersion, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getMarketQuoteOHLCValidateBeforeCall(String symbol, String interval, String apiVersion, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'symbol' is set
        if (symbol == null) {
        ...
        okhttp3.Call call = getMarketQuoteOHLCCall(symbol, interval, apiVersion, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<GetMarketQuoteOHLCResponse> getMarketQuoteOHLCWithHttpInfo(String symbol, String interval, String apiVersion) throws ApiException {
        okhttp3.Call call = getMarketQuoteOHLCValidateBeforeCall(symbol, interval, apiVersion, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call getMarketQuoteOHLCAsync(String symbol, String interval, String apiVersion, final ApiCallback<GetMarketQuoteOHLCResponse> callback) throws ApiException {
        ...
        okhttp3.Call call = getMarketQuoteOHLCValidateBeforeCall(symbol, interval, apiVersion, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetMarketQuoteOHLCResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public okhttp3.Call ltpCall(String symbol, String apiVersion, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call ltpValidateBeforeCall(String symbol, String apiVersion, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'symbol' is set
        if (symbol == null) {
        ...
        okhttp3.Call call = ltpCall(symbol, apiVersion, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<GetMarketQuoteLastTradedPriceResponse> ltpWithHttpInfo(String symbol, String apiVersion) throws ApiException {
        okhttp3.Call call = ltpValidateBeforeCall(symbol, apiVersion, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call ltpAsync(String symbol, String apiVersion, final ApiCallback<GetMarketQuoteLastTradedPriceResponse> callback) throws ApiException {
        ...
        okhttp3.Call call = ltpValidateBeforeCall(symbol, apiVersion, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetMarketQuoteLastTradedPriceResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
