...
public class OptionsApi {
     ...
     */
    public okhttp3.Call getOptionContractsCall(String instrumentKey, String expiryDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private okhttp3.Call getOptionContractsValidateBeforeCall(String instrumentKey, String expiryDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        okhttp3.Call call = getOptionContractsCall(instrumentKey, expiryDate, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<GetOptionContractResponse> getOptionContractsWithHttpInfo(String instrumentKey, String expiryDate) throws ApiException {
        okhttp3.Call call = getOptionContractsValidateBeforeCall(instrumentKey, expiryDate, null, null);
     ...
     */
    public okhttp3.Call getOptionContractsAsync(String instrumentKey, String expiryDate, final ApiCallback<GetOptionContractResponse> callback) throws ApiException {
        ...
        okhttp3.Call call = getOptionContractsValidateBeforeCall(instrumentKey, expiryDate, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetOptionContractResponse>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public okhttp3.Call getPutCallOptionChainCall(String instrumentKey, String expiryDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getPutCallOptionChainValidateBeforeCall(String instrumentKey, String expiryDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'instrumentKey' is set
        if (instrumentKey == null) {
        ...
        okhttp3.Call call = getPutCallOptionChainCall(instrumentKey, expiryDate, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<GetOptionChainResponse> getPutCallOptionChainWithHttpInfo(String instrumentKey, String expiryDate) throws ApiException {
        okhttp3.Call call = getPutCallOptionChainValidateBeforeCall(instrumentKey, expiryDate, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call getPutCallOptionChainAsync(String instrumentKey, String expiryDate, final ApiCallback<GetOptionChainResponse> callback) throws ApiException {
        ...
        okhttp3.Call call = getPutCallOptionChainValidateBeforeCall(instrumentKey, expiryDate, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetOptionChainResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
